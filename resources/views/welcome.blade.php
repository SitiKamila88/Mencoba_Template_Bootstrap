              ...
              <nav class="navbar navbar-expand-lg">
                ...
                >
                  <ul id="nav" class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                      <a class="page-scroll" href="#features">Quartz</a>
                    </li>
                    <li class="nav-item">
          ...
          <div class="col-lg-4 col-md-8 col-sm-10">
            <div class="single-feature">
              ...
              <div class="content">
                <h3>Amethys</h3>
                <p>
                  Elegant Purple to Shoothe your soul.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-8 col-sm-10">
            <div class="single-feature">
              ...
              <div class="content">
                <h3>Lapiz Lazuli</h3>
                <p>
                  Cool Blue that make you grounded.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-8 col-sm-10">
            <div class="single-feature">
              ...
              <div class="content">
                <h3>Jade</h3>
                <p>
                  Fresh soft green that calms your nervous system
                </p>
              </div>
            </div>
          </div>
